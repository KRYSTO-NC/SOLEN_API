...
Nous avons reçu une demande de réinitialisation de mot de passe pour votre compte. Pour procéder à la réinitialisation, veuillez suivre les instructions ci-dessous :
1.Cliquez sur le lien suivant pour accéder à la page de réinitialisation de mot de passe :   \n\n ${resetUrl}
2.Vous serez redirigé(e) vers une page où vous pourrez entrer votre nouveau mot de passe.
3.Veuillez choisir un mot de passe sécurisé et facile à mémoriser. Assurez-vous qu'il contient au moins huit caractères, avec une combinaison de lettres, de chiffres et de caractères spéciaux.
